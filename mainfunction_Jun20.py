...
pitchshiftset = 2*(np.arange(PN) - int(0.5*PN) ) 
timestretchset = [0.75, 1, 1.5]
...
outfolder = parentfolder +  "/librosa/bitest/"
...
def main(param=0.2, PATH_LOAD_FILE=input_file, PATH_SAVE_FILE='./SAVE_RESULTS/pop1.txt'):
    ...
    if 1 : 
        ...
        outfilepath = adjust_tuning(wav2fileset)
        wav2fileset =  glob.glob(outfilepath) 
